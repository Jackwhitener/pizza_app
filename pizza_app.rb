def pizza(size,crust,sauce,cheese,toppings)
puts "Your pizza is a #{size} inch pie, with #{crust} crust, #{sauce} sauce, #{cheese} cheese, #{toppings} on top."
end
...
toppings = gets.chomp
pizza(size,crust,sauce,cheese,toppings)